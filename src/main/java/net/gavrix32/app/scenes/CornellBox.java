    ...
    public CornellBox() {
        ...
        scene.addBoxes(
                ...
                new Box(new Vector3f(-50, 100, 50), // Left wall
                        new Vector3f(0, 0, 0),
                        new Vector3f(1, 0, 0),
                        new Vector3f(0, 100, 150), new Material(false, 0, 1, 1, false)
                ),
                ...
                new Box(new Vector3f(50, 200, 50), // Roof
                        new Vector3f(0, 0, 0),
                        new Vector3f(1, 1, 1),
                        new Vector3f(100, 0, 150), new Material(false, 0, 1, 1, false)
                ),
                ...
                new Box(new Vector3f(50, 199.999f, 50), // Light
                        new Vector3f(0, 0, 0),
                        new Vector3f(1, 1, 1),
                        new Vector3f(25, 0.1f, 25), new Material(false, 50, 1, 1, false)
                )
